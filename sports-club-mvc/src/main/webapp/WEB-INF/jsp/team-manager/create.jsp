...
<t:pagetemplate pageTitle="Create Team Manager">
    <jsp:attribute name="content">
        <h1>New Team manager</h1>
        <form:form method="post" action="${pageContext.request.contextPath}/team-manager/create"
                   modelAttribute="teamManager" cssClass="form-horizontal" data-toggle="validator">
            ...
            <button class="btn btn-primary" type="submit">Create Team manager</button>
